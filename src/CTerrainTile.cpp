...
void CTerrainTile::generateMesh()
{
    ...
    */
    ...
    if ( ETT_WATER_SUBMERGED_SLOPE_SW == _type || ETT_WATER_SUBMERGED_SLOPE_NE == _type
        ...
        ||  ETT_WATER_SUBMERGED_SLOPE_N == _type)
    {
        _vertexCount = 6;
        _vertices = new S3DVertex[_vertexCount];
...
void CTerrainTile::setTexture()
{
    ...
    if ( ETT_WATER_SUBMERGED_SLOPE_SW == _type || ETT_WATER_SUBMERGED_SLOPE_N == _type )
    {
        _vertices[0].texcoord[0] = 1;
    ...
    if ( ETT_HIGHGROUND == _type )
    {
        ...
        // triangle 9
        _vertices[24].texcoord[0] = 0.0f;
        _vertices[24].texcoord[1] = 0.5f;

        _vertices[25].texcoord[0] = 0.0f;
        _vertices[25].texcoord[1] = 0.0f;

        _vertices[26].texcoord[0] = 0.5f;
        _vertices[26].texcoord[1] = 0.0f;

        // triangle 10
        _vertices[27].texcoord[0] = 0.0f;
        _vertices[27].texcoord[1] = 0.0f;

        _vertices[28].texcoord[0] = 0.0f;
        _vertices[28].texcoord[1] = 0.5f;

        _vertices[29].texcoord[0] = 0.5f;
        _vertices[29].texcoord[1] = 0.5f;
    }
    else
    ...
    if (ETT_WATERFALL == _type)
    {
        ...
        _vertices[7].texcoord[0] = 0.0f;
        _vertices[7].texcoord[1] = 1.0f;

        _vertices[8].texcoord[0] = 0.5f;
        _vertices[8].texcoord[1] = 1.0f;

        // triangle 4
        _vertices[9].texcoord[0] = 0.5f;
        _vertices[9].texcoord[1] = 1.0f;
